...
export function get_transaction_version(network_type: string) {
    if (network_type === 'mainnet') {
        return transactions.TransactionVersion.Mainnet;
    } else {
        return transactions.TransactionVersion.Testnet;
    }
}